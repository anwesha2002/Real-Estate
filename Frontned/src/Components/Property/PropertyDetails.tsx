        ...
        >
            ...
            <Box  display="flex" mt="20px" flexDirection={{xs : "column", lg : "row"}} gap={4}>
                <Box flex={1} maxWidth={764}>
                    <img height={600} width={700} style={{objectFit : "cover", borderRadius : '10px'}}  src={details?.photo} alt="detailed-property-photo"/>
                    <Box mt="15px">
                ...
                <Box  width="100%" flex={1}  maxWidth={326} display="flex" flexDirection="column" gap="20px">
                    <Stack p={2} width="100%" direction="column" justifyContent="center" alignItems="center" border="1px solid #E4E4E4" borderRadius={2}>
                        <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
                            ...
                            />
                            <Box mt="15px">
                                <Typography fontSize={18} fontWeight={600} color="#11142D" textTransform="Capitalize">
                        ...
                        >
                            <CustomButton
                                ...
                                handleClick={() => {navigate("/property/create", {state : { id : id && id, details : details }})}}
                            />
                            <CustomButton
